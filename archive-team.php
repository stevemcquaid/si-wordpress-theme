...
<article class="container">
  ...
  <ul class="team-list">
    ...
    // Start the Loop.
      ...
      <li class="member">
        <a href=""></a>
          <img class="image" src="<?php echo wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'full' )[0]; ?>">
          <?php $title = explode("^", get_the_title()); ?>
          <h2 class="name"><?php echo $title[0]; ?></h1>
          <h3 class="title"><?php echo the_excerpt(); ?></h2>
